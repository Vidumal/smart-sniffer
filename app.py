...
class WiresharkPro(ctk.CTk):
    def __init__(self):
        ...
        self.tree = ttk.Treeview(self.table_frame, columns=("No.", "Source", "Destination", "Location", "Owner", "Risk"), show='headings')
    ...
    def add_to_table(self, data):
        ...
        self.tree.insert("", "end", iid=data["id"], values=(data["id"], data["src"], data["dst"], location, owner, data["risk"]))
